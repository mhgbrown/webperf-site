...
search:escape(JSON.encode(GamefinderParams))};swfobject.embedSWF("resources/assets/flash/main.swf?"+rand(1E6),"game-finder-flash",996,441,"9.0.0",null,a,{wmode:"opaque",align:"middle",scale:"noscale",allowFullScreen:"false",allowScriptAccess:"sameDomain",play:"true",quality:"high"},{})}};window.addEvent("domready",function(){Ubisoft.Homepage.init()});function openWindow(a,b){var c=window.open(a,b);c?c.focus():Ubisoft.Gamefinder.openWindowFromSwf(a,b)}
