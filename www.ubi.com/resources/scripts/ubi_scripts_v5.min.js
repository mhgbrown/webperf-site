...
hideFlashPromo()},closePromotion:function(){dialog.hide();Ubisoft.Homepage.loadGamefinder()},initFlashArea:function(){if($("flash-container").getStyle("height")=="0px"){$("flash-container").setStyles({"border-bottom":"none",height:"auto"});$("game-finder").setStyles({height:446,width:996})}$("primary-spotlight").setStyle("display","none")},loadGamefinder:function(){Ubisoft.Homepage.initFlashArea();$("game-finder").setStyles({width:996});var a={configUrl:"http://cdn.webperflab.com/2012/grayfox/a3/www.ubi.com/config/application.xml",configUrlMain:"http://cdn.webperflab.com/2012/grayfox/a3/www.ubi.com/config/mainApplication.07312012.xml",
search:escape(JSON.encode(GamefinderParams))};swfobject.embedSWF("http://cdn.webperflab.com/2012/grayfox/a3/www.ubi.com/resources/assets/flash/main.swf?"+rand(1E6),"game-finder-flash",996,441,"9.0.0",null,a,{wmode:"opaque",align:"middle",scale:"noscale",allowFullScreen:"false",allowScriptAccess:"sameDomain",play:"true",quality:"high"},{})}};window.addEvent("domready",function(){Ubisoft.Homepage.init()});function openWindow(a,b){var c=window.open(a,b);c?c.focus():Ubisoft.Gamefinder.openWindowFromSwf(a,b)}
